...
// неработоспособны. Отсечение обеспечит пункт 3.4 через статически вычислимое ветвление
// по __ANIMORI_PLATFORM__, которое Rollup сворачивает на этапе сборки.
//
