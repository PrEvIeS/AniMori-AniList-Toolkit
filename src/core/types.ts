// Пункт 1.4 плана: типы данных, вынесенные из JSDoc-блока монолита (строки 1492-1600).
//
// Монолит стоял под @ts-nocheck и описывал эти структуры через @typedef. Здесь они
// становятся настоящими интерфейсами: это единственный источник правды по форме данных
// для api/*, core/db.ts и будущих Vue-компонентов Этапа 2.
//
// Поля помечены необязательными ровно там, где внешние API реально их не гарантируют.
