// Секция 7 монолита (строки 3738-3793): контекстный захват выделенного текста.
//
...
//
// Сама логика словаря уже живёт в core/dictionary.ts (upsertUserDictEntry сам пересобирает
// словарь и дёргает ре-скан DOM), здесь только UI — императивный, 1:1 с монолитом.
