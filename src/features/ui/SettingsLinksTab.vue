<!--
  Итерация 5.1: панель «Ссылки» вынесена из SettingsModal.vue без правки разметки.
  Идентификаторы (set_extlinks, set_link_*, set_*_domain, am-custom-*) сохранены.

  Домены и свои ссылки пишутся по событию change, а не на каждое нажатие клавиши:
  иначе в хранилище уезжали бы недописанные адреса, а normalizeDomain резал бы их на лету.
-->
<template>
  <div class="amk-card">
