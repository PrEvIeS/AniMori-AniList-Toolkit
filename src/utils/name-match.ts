// Пункт 1.4 плана: единый скоринговый матчер имён (строки 1903-1951 монолита).
//
// Живёт в utils, а не в api: это чистые функции без сети, нужны и клиенту Shikimori,
// и сканеру дельты (cmpNormName / cmpNameDiff позже переедут сюда же).
//
// Шкала баллов перенесена 1:1 — менять её нельзя без проверки на живых данных:
...
/** Кандзи/кана: убираем все пробелы — разделители в источниках разные. */
